...
<p align="center">
<img width="380" height="428" alt="SCR-20251110-kbqz" src="https://github.com/user-attachments/assets/9d8d77aa-7801-4575-b1e1-d62213476710" />
</p>
...
2. Введите API-ключи или добавьте свои запросы, если ИИ недоступен.
3. Укажите, сколько должна длиться сессия и как долго задерживаться на сайтах.
4. Нажмите «Сохранить».
5. В UI-меню нажмите **Start**, чтобы запустить работу. Кнопкой **Stop** можно остановить в любой момент.
...
2. Нажми "Перетащите файл **CRX** в Chrome"
![установка](https://github.com/user-attachments/assets/ac58b17b-ee58-4dbc-8e7e-5a5c4ac02fa9)
